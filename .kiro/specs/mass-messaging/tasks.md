...
- [ ] 12. Plantillas de mensaje y envíos programados
    ...
    - [ ] 12.3 Crear el comando `campaigns:dispatch-scheduled` y registrarlo en el Scheduler
    ...
    - [ ]\* 12.4 Escribir tests para plantillas y envíos programados
...
- [ ] 14. Tests de propiedad (property-based testing con Pest)
    - [ ]\* 12.1 P1: Sustitución completa de variables — `tests/Unit/Messaging/MessageVariableResolverTest.php`
    ...
    - [ ]\* 12.2 P2: Selección de idioma según preferred_locale — `tests/Unit/Messaging/LocaleSelectionTest.php`
    ...
    - [ ]\* 12.3 P3: Fallback de idioma cuando solo hay una versión — `tests/Unit/Messaging/LocaleSelectionTest.php`
    ...
    - [ ]\* 12.4 P4: Unicidad de tokens de tracking — `tests/Unit/Messaging/TrackingTokenTest.php`
    ...
    - [ ]\* 12.5 P5: Resolución de destinatarios por filtro de portal/garaje — `tests/Unit/Messaging/RecipientResolverTest.php`
    ...
    - [ ]\* 12.6 P6: Generación de Recipients por contactos válidos — `tests/Unit/Messaging/RecipientResolverTest.php`
    ...
    - [ ]\* 12.7 P7: Métricas únicas de tracking — `tests/Unit/Messaging/TrackingMetricsTest.php`
    ...
    - [ ]\* 12.8 P8: Autorización por rol en filtros de Campaign — `tests/Feature/Messaging/CampaignPolicyTest.php`
    ...
    - [ ]\* 12.9 P9: Validación de longitud de asunto — `tests/Unit/Messaging/CampaignValidationTest.php`
...
- Los tests de propiedad (tarea 12) usan Pest nativo con `fake()`, datasets y `->repeat(2)` — sin dependencias adicionales
