...
- **Docker-first in this repository**: Execute project commands in Docker (`docker compose exec madaia33 ...` or `docker compose run --rm --user ${DC_UID:-1000}:${DC_GID:-1000} madaia33 ...`)
