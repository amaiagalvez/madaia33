...
class VotingEligibilityService
{
    ...
    public function ownerCanVoteAtVotingDate(Voting $voting, Owner $owner): bool
    {
        return $this->eligibleAssignmentsAtDate($voting, $owner, $this->votingReferenceDate($voting))->isNotEmpty();
    }
