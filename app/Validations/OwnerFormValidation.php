...
class OwnerFormValidation
{
    ...
    public static function profileUpdateRules(int $userId): array
    {
        return [
            ...
            'coprop1_has_whatsapp' => ['nullable', 'boolean'],
            ...
            'coprop2_has_whatsapp' => ['nullable', 'boolean'],
    ...
    public static function adminEditRules(int $userId): array
    {
        return [
            ...
            'editCoprop1HasWhatsapp' => ['nullable', 'boolean'],
            ...
            'editCoprop2HasWhatsapp' => ['nullable', 'boolean'],
