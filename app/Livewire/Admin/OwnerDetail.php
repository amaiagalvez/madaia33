...
class OwnerDetail extends Component
{
  ...
  public function assignProperty(): void
  {
    ...
    try {
      (new AssignPropertyAction)->execute($property, $this->owner, $this->assignStartDate);
  ...
  public function confirmUnassign(): void
  {
    ...
    try {
      (new UnassignPropertyAction)->execute($assignment, $this->unassignEndDate);
  ...
  {
    (new DeactivateOwnerAction)->execute($this->owner);
    $this->owner->refresh();
  }
