<x-layouts::shared.auth :title="__('Two-factor authentication')">
    <div class="flex flex-col gap-6">
        <div class="relative w-full h-auto" x-cloak x-data="{
            ...
            <div x-show="!showRecoveryInput">
                <x-auth.auth-header :title="__('Authentication code')" :description="__(
                    'Enter the authentication code provided by your authenticator application.',
                )" />
            </div>

            <div x-show="showRecoveryInput">
                <x-auth.auth-header :title="__('Recovery code')" :description="__(
                ...
                <div class="space-y-5 text-center">
                    <div x-show="!showRecoveryInput">
                        <div class="flex items-center justify-center my-5">
                            <flux:otp x-model="code" length="6" name="code" label="OTP Code"
