...
<x-admin.bilingual-field-tabs :title="__('admin.settings_form.contact_form_subject')" :locale-configs="$this->localeConfigsFor(
    'contactFormSubject',
    'admin.settings_form.contact_form_subject',
)" mode="plain" />
