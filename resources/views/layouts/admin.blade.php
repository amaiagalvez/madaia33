        ...
        <aside
            ...
            <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto"
                ...
                <a href="{{ route('admin.legal-pages') }}"
                    class="flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium transition-colors {{ request()->routeIs('admin.legal-pages') ? 'bg-amber-100 text-amber-900' : 'text-stone-600 hover:bg-amber-50 hover:text-stone-900' }}">
                    <svg class="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24"
                        stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div x-show="open" x-transition class="fixed inset-0 z-50 flex">
                ...
                <div
                    ...
                    <nav class="flex-1 px-4 py-6 space-y-1">
                        ...
                        <a href="{{ route('admin.legal-pages') }}"
                            class="block px-3 py-2 rounded-md text-sm font-medium text-stone-700 hover:bg-amber-50 transition-colors">{{ __('admin.legal_pages') }}</a>
                        <a href="{{ route('admin.settings') }}"
