...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:header container
        ...
        <x-shared.app-logo href="{{ route('admin.dashboard') }}" wire:navigate />
        ...
        <flux:navbar class="me-1.5 space-x-0.5 rtl:space-x-reverse py-0!">
            ...
            <flux:tooltip :content="__('Documentation')" position="bottom">
                <flux:navbar.item class="h-10 max-lg:hidden [&>div>svg]:size-5"
                    icon="book-open-text" href="https://laravel.com/docs/starter-kits#livewire"
                    target="_blank" :label="__('Documentation')" />
            </flux:tooltip>
        </flux:navbar>
    ...
    <flux:sidebar collapsible="mobile" sticky
        ...
        <flux:sidebar.header>
            <x-shared.app-logo :sidebar="true" href="{{ route('admin.dashboard') }}"
                wire:navigate />
